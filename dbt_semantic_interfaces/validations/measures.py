...
class MetricWithoutSourceHasExtraFieldsRule(
    ...
    def _get_sourceless_metric_fields_from_metric(metric: Metric) -> List[str]:
        ...
        all_sourceless_only_fields = (
            MetricWithoutSourceHasExtraFieldsRule.SOURCELESS_REQUIRED_FIELDS
            + MetricWithoutSourceHasExtraFieldsRule.SOURCELESS_OPTIONAL_FIELDS
        )
    ...
    def _get_required_fields_missing_from_sourceless_metric(metric: Metric) -> List[str]:
        ...
        return [
            field
            for field in MetricWithoutSourceHasExtraFieldsRule.SOURCELESS_REQUIRED_FIELDS
    ...
    def validate_manifest(semantic_manifest: SemanticManifestT) -> Sequence[ValidationIssue]:  # noqa: D
        ...
        # Is this 'or []' needed?
        for metric in semantic_manifest.metrics:
            has_source = MetricWithoutSourceHasExtraFieldsRule._has_separate_source(metric)
            if has_source:
                illegal_sourceless_only_fields = (
                    MetricWithoutSourceHasExtraFieldsRule._get_sourceless_metric_fields_from_metric(metric)
                )
            ...
            missing_required_sourceless_fields = (
                MetricWithoutSourceHasExtraFieldsRule._get_required_fields_missing_from_sourceless_metric(metric)
            )
