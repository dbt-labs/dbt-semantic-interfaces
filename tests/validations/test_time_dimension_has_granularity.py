...
def test_time_dimension_missing_granularity() -> None:  # noqa: D
...
def test_time_dimension_with_granularity_ok() -> None:  # noqa: D
    semantic_manifest = PydanticSemanticManifest(
        semantic_models=[
            semantic_model_with_guaranteed_meta(
...
def test_non_time_dimension_ok() -> None:  # noqa: D
    semantic_manifest = PydanticSemanticManifest(
        semantic_models=[
            semantic_model_with_guaranteed_meta(
